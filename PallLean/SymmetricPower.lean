...
-- ARCHIVED (2026-05-23): false axiom `spdp_profile_generators` + `product_leibniz_profile_cover` + `leibniz_symmetric_power_descent_bound` moved to PallLean/Archive/Paper93Unsafe/SpdpProfileGeneratorsAxiom.lean (Unsafe; excluded from default build).
