...
-- ARCHIVED (inc4): unconditional p_side_rank_bound_for_cook_levin (false n^200) -> Archive/Paper93Unsafe/PaperFaithfulSeparationUnsafe.lean
...
milestones. -/
-- ARCHIVED (inc4): legacy + P_ne_NP_via_* (spdp/gauge separation claims) -> Archive/Paper93Unsafe/PaperFaithfulSeparationUnsafe.lean
...
-- ARCHIVED (inc4): exists_amplituhedron_gauge_for_sat_decider_from_theorem207 -> Archive/Paper93Unsafe/PaperFaithfulSeparationUnsafe.lean
...
-- ARCHIVED (inc4): P_ne_NP_unconditional_ARCHIVED + :False witness + step4* -> Archive/Paper93Unsafe/PaperFaithfulSeparationUnsafe.lean
