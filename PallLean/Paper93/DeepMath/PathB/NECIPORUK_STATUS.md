...
**restricted** lower bound on an explicit function, fully proved with no carried
hypothesis, but it is **not** P vs NP. The Nečiporuk method provably cannot exceed
`n²/log n`, so this arc is closed: there is no further strengthening to chase here.
