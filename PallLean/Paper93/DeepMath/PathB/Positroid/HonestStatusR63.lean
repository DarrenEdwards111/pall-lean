...
/-- **Honest status (round 63):** kernel-only progress includes closed-form det
    formulas at n=1,2,3,4 — newly extended in this round to n=4 via direct
    cofactor expansion. -/
theorem honest_status_r63 :
    ...
    -- (DONE-5 NEW R63) Closed-form det at n=2,3,4
...
theorem upstream_axiom_remains_r63 :
