...
theorem compiledGadget_5_2_det : (compiledGadget 5 2).det = 35 := by
  rw [compiledGadget_2x2_det]; norm_num

theorem compiledGadget_5_3_det : (compiledGadget 5 3).det = 320 := by
  rw [compiledGadget_3x3_det]; norm_num

theorem compiledGadget_5_4_det : (compiledGadget 5 4).det = 3645 := by
